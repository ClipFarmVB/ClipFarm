...
| [`RULES.md`](./RULES.md) | **every iteration** — hard rules, evidence, the push test, logging, priority order, the ceiling and the budget, measuring what you publish, repo traps | 11.2k |
...
one that also spawns a round, about 34k. A step-2 lap is about 24k, a step-3 lap
